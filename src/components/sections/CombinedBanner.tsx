...
import styles from './CombinedBanner.module.scss';

const CombinedBanner: React.FC = () => {
    const services = [
        {
            id: 1,
    ...
    return (
        <section className={styles.combinedBanner}>
            <div className={styles.container}>
                ...
                <div className={styles.titleSection}>
                    <h1 className={styles.title}>
                        <span className={styles.titleTop}>We provide</span>
